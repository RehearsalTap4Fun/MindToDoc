...
| SFX_SLICE_SUCCESS | 足球 | P0 | 1.5s | 切片成功统一音（进球庆祝感，高频小庆祝、短促克制） | Soccer goal moment, crisp net swish on impact then a quick punchy burst of stadium crowd energy as a bed, snappy satisfying rewarding, light short brass accent not a full fanfare, mobile game feedback, no commentary, no announcer, no singing, clean mix |
...
| SFX_MATCH_WIN | 足球 | P0 | 2.0s | 关卡结算胜（低频大庆祝，宏大）；**联赛轮完成、淘汰赛晋级** | Big triumphant match victory fanfare, full bright brass section swelling over a wide stadium crowd roar, grand celebratory climactic, soccer championship win, mobile game result screen, no commentary, no announcer, no singing, clean mix |
