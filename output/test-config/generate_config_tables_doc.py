...
SHEET_META: dict[str, dict[str, str]] = {
    ...
    "ActvSoccerAiProfileCfg": {"用途": "关卡 AI 难度档", "关联": "←LevelCfg；→SliceAiCfg", "填表": "数值"},
    "ActvSoccerEnemyAiCfg": {"用途": "门将/后卫 AI 权重", "关联": "←SliceAiCfg（Goalkeeper/Defender/Shooter）", "填表": "数值"},
    "ActvSoccerSliceAiCfg": {"用途": "单切片 AI 绑定", "关联": "SliceID→Instance；引用 Profile/EnemyAi/Modifier", "填表": "关卡"},
    "ActvSoccerAiModifierCfg": {"用途": "切片机制（移动门将等）", "关联": "←SliceAiCfg.ModifierID", "填表": "关卡"},
